---
source_file: "tests/test_ai_import.py"
type: "code"
...
## Connections
- [[Duck-typed stand-in for the locally-defined _ParsedWorkout model.]] - `rationale_for` [EXTRACTED]
- [[WorkoutDaySummary_4]] - `references` [EXTRACTED]
- [[test_ai_import.py]] - `contains` [EXTRACTED]
